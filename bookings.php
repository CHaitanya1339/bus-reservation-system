...
<link rel="stylesheet" href="adminnicepage/Bookings.css" media="screen">
...
tr:nth-child(even) {background-color: #f2f2f2}
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-fe07"><div class="u-clearfix u-sheet u-sheet-1">
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="bookings.html" style="padding: 10px 20px;">Bookings</a>
...
$sql = "SELECT pasname, pasemail, pasphone, pasgender, pasage, bname, acity, dcity, fare, stype FROM passengerdetails";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
// output data of each row
while($row = $result->fetch_assoc()) {
echo "<tr><td>" . $row["pasname"]. "</td><td>" . $row["pasemail"] . "</td><td>".$row["pasphone"] . "</td><td>".$row["pasgender"] . "</td><td>".$row["pasage"] . "</td><td>".$row["bname"] . "</td><td>".$row["acity"] . "</td><td>".$row["dcity"] . "</td><td>".$row["fare"] . "</td><td>". $row["stype"] . "</td></tr>";
}
echo "</table>";
} else { echo "0 results"; }
$conn->close();
