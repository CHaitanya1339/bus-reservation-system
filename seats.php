...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="seats.html" style="padding: 10px 20px;">Availability</a>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="seats.html" style="padding: 10px 20px;">Availability</a>
...
$sql = "SELECT type, busname, arrivalcity, destinationcity, seats FROM Buses";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
// output data of each row
while($row = $result->fetch_assoc()) {
echo "<tr><td>" . $row["type"]. "</td><td>" . $row["busname"] . "</td><td>". $row["arrivalcity"] . "</td><td>" . $row["destinationcity"] . "</td><td>"
. $row["seats"] . "</td></tr>";
}
echo "</table>";
} else { echo "0 results"; }
